<section class="card border-0 shadow-sm">
    <div class="card-body p-4 p-lg-5">
        <h1 class="h3 mb-3"><?= e((string) ($pageTitle ?? 'Politica de Privacidade')) ?></h1>
        <p class="text-muted">Ultima atualizacao: <?= e(date('d/m/Y')) ?></p>

        <h2 class="h5 mt-4">1. Dados coletados</h2>
        <ul>
        ...
        <h2 class="h5 mt-4">2. Finalidades de tratamento</h2>
        <ul>
        ...
        <h2 class="h5 mt-4">3. Analise de dados</h2>
        ...
        <h2 class="h5 mt-4">5. Retencao e descarte</h2>
