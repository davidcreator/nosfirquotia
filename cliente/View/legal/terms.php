<section class="card border-0 shadow-sm">
    <div class="card-body p-4 p-lg-5">
        <h1 class="h3 mb-3"><?= e((string) ($pageTitle ?? 'Termos de Uso')) ?></h1>
        ...
        <h2 class="h5 mt-4">3. Orcamentos e validade</h2>
        ...
        <h2 class="h5 mt-4">4. Propriedade intelectual</h2>
        ...
        <h2 class="h5 mt-4">5. Limitacao de responsabilidade</h2>
