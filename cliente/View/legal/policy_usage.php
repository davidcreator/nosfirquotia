<section class="card border-0 shadow-sm">
    <div class="card-body p-4 p-lg-5">
        <h1 class="h3 mb-3"><?= e((string) ($pageTitle ?? 'Politica de Uso')) ?></h1>
        ...
        <h2 class="h5 mt-4">3. Condutas proibidas</h2>
        <ul>
        ...
        <h2 class="h5 mt-4">4. Medidas de seguranca e conformidade</h2>
        ...
        <h2 class="h5 mt-4">5. Medidas administrativas</h2>
